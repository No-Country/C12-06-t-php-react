...
const Copyrght = () => {
  return (
    <article className="w-full flex flex-col gap-8 pb-12 laptop:flex-row-reverse laptop:justify-between">
      <ul className="w-full flex items-center justify-start gap-4 laptop:w-auto">
        <li>
          <Link href="#">
      ...
      <span className="text-DarkGray uppercase">
