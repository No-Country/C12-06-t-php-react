...
const Footer = () => {
  return (
    <footer className="w-full flex flex-col gap-4 pl-4 pt-20 bg-DarkSlateGray laptop:px-8 laptop:pt-12">
      <div className="w-full flex flex-col items-start justify-start gap-8 laptop:flex-row">
        ...
        <article className="w-full flex flex-col items-start justify-start gap-4 pr-4 laptop:w-[60%]">
          <p className="uppercase font-semibold text-DarkGray">
      ...
      <hr className="w-[95%] border-DimGray pr-4 my-8 laptop:w-[100%]" />
      <Copyrght />
    </footer>
  );
};
