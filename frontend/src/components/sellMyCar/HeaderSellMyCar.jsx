                ...
                <figure className="w-full flex items-center justify-end relative">
                    ...
                    <div className="absolute top-0 right-0 bottom-0 left-0 m-auto w-full flex flex-col items-center justify-center text-center gap-1">
                        ...
                        <p className="text-White max-w-[70%] text-[.5em] s:text-xs sm:text-sm base:text-base md:text-lg">
                            En AutoApp, estamos comprometidos a hacer que el proceso de venta de tu auto usado sea rápido, seguro
                            y sin complicaciones.
                        </p>
                        <div className="hidden w-full s:flex items-center justify-center gap-4 mt-4 text-sm base:text-base">
                            <button className="py-1 px-2 bg-White text-OrangeRed rounded-md sm:py-2 sm:px-3">Contactanos</button>
                            <button className="py-1 px-2 bg-OrangeRed text-White rounded-md sm:py-2 sm:px-3">Ver video</button>
                        </div>
                    </div>
                </figure>
                <div className="w-full flex items-center justify-center gap-4 mt-4 text-xs s:hidden">
                    <button className="py-1 px-2 bg-White text-OrangeRed border border-OrangeRed rounded-md">Contactanos</button>
                    <button className="py-1 px-2 bg-OrangeRed text-White rounded-md">Ver video</button>
                </div>
            </article>
